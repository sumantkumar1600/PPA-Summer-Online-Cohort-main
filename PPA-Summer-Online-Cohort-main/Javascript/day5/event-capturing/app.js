...
for (let i = 0; i < recipes.length; i++) {
    ...
    newContainer.innerHTML = `
        ...
        <button onclick="addRecipeToCart(event)">Add</button>
    `;
...
const dummyRootClicked = (e) => {
    console.log("Root Element clicked", e);
};
...
dummyBtn.addEventListener("click", handleDummyButtonClick); // bubbling

parentElem.addEventListener("click", dummyRootClicked, true); // capturing
